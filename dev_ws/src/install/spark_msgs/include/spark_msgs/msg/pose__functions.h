...
#ifndef SPARK_MSGS__MSG__POSE__FUNCTIONS_H_
#define SPARK_MSGS__MSG__POSE__FUNCTIONS_H_
 ...
 * spark_msgs__msg__Pose__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * spark_msgs__msg__Pose__Sequence__fini()
 * on the array,
...
#endif  // SPARK_MSGS__MSG__POSE__FUNCTIONS_H_
