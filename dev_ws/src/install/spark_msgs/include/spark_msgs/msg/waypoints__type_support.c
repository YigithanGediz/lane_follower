...
static rosidl_typesupport_introspection_c__MessageMember Waypoints__rosidl_typesupport_introspection_c__Waypoints_message_member_array[3] = {
  {
    ...
    offsetof(spark_msgs__msg__Waypoints, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(spark_msgs__msg__Waypoints, waypoint_count),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(spark_msgs__msg__Waypoints, waypoints),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Waypoints__rosidl_typesupport_introspection_c__Waypoints_message_members = {
  ...
  3,  // number of fields
  sizeof(spark_msgs__msg__Waypoints),
