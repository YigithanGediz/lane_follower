...
class GoalState(metaclass=Metaclass_GoalState):
    ...
    def __init__(self, **kwargs):
        ...
        self.goal_index = kwargs.get('goal_index', int())
    ...
    def goal_index(self, value):
        if __debug__:
            ...
            assert value >= -2147483648 and value < 2147483648, \
                "The 'goal_index' field must be an integer in [-2147483648, 2147483647]"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'goal_state' field must be a set or sequence and each value of type 'float'"
