...
class Lane(metaclass=Metaclass_Lane):
    ...
    def __init__(self, **kwargs):
        ...
        self.lane = array.array('h', kwargs.get('lane', []))
    ...
    def lane(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'h', \
                "The 'lane' array.array() must have the type code of 'h'"
            self._lane = value
            return
        if __debug__:
            ...
            assert \
                ...
                "The 'lane' field must be a set or sequence and each value of type 'int' and each integer in [-32768, 32767]"
        self._lane = array.array('h', value)
