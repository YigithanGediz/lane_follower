...
bool spark_msgs__msg__waypoint_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "spark_msgs.msg._waypoint_data.WaypointData",
...
{
  /* NOTE(esteve): Call constructor of WaypointData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("spark_msgs.msg._waypoint_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "WaypointData");
