...
class Waypoints(metaclass=Metaclass_Waypoints):
    ...
    def __init__(self, **kwargs):
        ...
        self.waypoints = array.array('d', kwargs.get('waypoints', []))
    ...
    def waypoint_count(self, value):
        if __debug__:
            ...
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'waypoint_count' field must be an integer in [-9223372036854775808, 9223372036854775807]"
    ...
    def waypoints(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'd', \
                "The 'waypoints' array.array() must have the type code of 'd'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'waypoints' field must be a set or sequence and each value of type 'float'"
        self._waypoints = array.array('d', value)
