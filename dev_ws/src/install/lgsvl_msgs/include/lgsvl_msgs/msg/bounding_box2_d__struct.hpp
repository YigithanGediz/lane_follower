...
#ifndef LGSVL_MSGS__MSG__BOUNDING_BOX2_D__STRUCT_HPP_
#define LGSVL_MSGS__MSG__BOUNDING_BOX2_D__STRUCT_HPP_
...
struct BoundingBox2D_
{
  ...
  explicit BoundingBox2D_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit BoundingBox2D_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // LGSVL_MSGS__MSG__BOUNDING_BOX2_D__STRUCT_HPP_
