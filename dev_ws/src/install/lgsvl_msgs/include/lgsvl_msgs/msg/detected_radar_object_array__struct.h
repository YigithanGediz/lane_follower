...
#ifndef LGSVL_MSGS__MSG__DETECTED_RADAR_OBJECT_ARRAY__STRUCT_H_
#define LGSVL_MSGS__MSG__DETECTED_RADAR_OBJECT_ARRAY__STRUCT_H_
...
#endif  // LGSVL_MSGS__MSG__DETECTED_RADAR_OBJECT_ARRAY__STRUCT_H_
