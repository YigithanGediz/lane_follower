...
#ifndef LGSVL_MSGS__MSG__DETECTED_RADAR_OBJECT__STRUCT_HPP_
#define LGSVL_MSGS__MSG__DETECTED_RADAR_OBJECT__STRUCT_HPP_
...
struct DetectedRadarObject_
{
  ...
  explicit DetectedRadarObject_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : sensor_aim(_init),
    sensor_right(_init),
  ...
  explicit DetectedRadarObject_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // LGSVL_MSGS__MSG__DETECTED_RADAR_OBJECT__STRUCT_HPP_
