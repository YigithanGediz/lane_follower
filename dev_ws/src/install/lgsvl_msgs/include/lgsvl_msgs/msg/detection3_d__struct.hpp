...
#ifndef LGSVL_MSGS__MSG__DETECTION3_D__STRUCT_HPP_
#define LGSVL_MSGS__MSG__DETECTION3_D__STRUCT_HPP_
...
struct Detection3D_
{
  ...
  explicit Detection3D_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init),
    bbox(_init),
    velocity(_init)
  {
  ...
  explicit Detection3D_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init),
    label(_alloc),
    bbox(_alloc, _init),
...
#endif  // LGSVL_MSGS__MSG__DETECTION3_D__STRUCT_HPP_
