...
#ifndef LGSVL_MSGS__MSG__VEHICLE_ODOMETRY__FUNCTIONS_H_
#define LGSVL_MSGS__MSG__VEHICLE_ODOMETRY__FUNCTIONS_H_
...
#endif  // LGSVL_MSGS__MSG__VEHICLE_ODOMETRY__FUNCTIONS_H_
