...
#ifndef LGSVL_MSGS__MSG__SIGNAL_ARRAY__STRUCT_HPP_
#define LGSVL_MSGS__MSG__SIGNAL_ARRAY__STRUCT_HPP_
...
struct SignalArray_
{
  ...
  explicit SignalArray_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init)
  {
    (void)_init;
  }

  explicit SignalArray_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init)
  {
    (void)_init;
  }
...
#endif  // LGSVL_MSGS__MSG__SIGNAL_ARRAY__STRUCT_HPP_
