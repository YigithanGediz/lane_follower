...
#include <stddef.h>
#include "spark_msgs/msg/waypoint__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember Waypoint__rosidl_typesupport_introspection_c__Waypoint_message_member_array[1] = {
  {
    "waypoint",  // name
    ...
    offsetof(spark_msgs__msg__Waypoint, waypoint),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Waypoint__rosidl_typesupport_introspection_c__Waypoint_message_members = {
  ...
  1,  // number of fields
  sizeof(spark_msgs__msg__Waypoint),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, spark_msgs, msg, Waypoint)() {
