...
class Metaclass_LaneList(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from spark_msgs.msg import Lane
...
class LaneList(metaclass=Metaclass_LaneList):
    ...
    _fields_and_field_types = {
        ...
        'x_coords': 'sequence<spark_msgs/Lane>',
        'y_coords': 'sequence<spark_msgs/Lane>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['spark_msgs', 'msg'], 'Lane')),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['spark_msgs', 'msg'], 'Lane')),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        self.x_coords = kwargs.get('x_coords', [])
        self.y_coords = kwargs.get('y_coords', [])
    ...
    def __eq__(self, other):
        ...
        if self.header != other.header:
            return False
        if self.x_coords != other.x_coords:
            return False
        if self.y_coords != other.y_coords:
            return False
        return True
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'x_coords' field must be a set or sequence and each value of type 'Lane'"
        self._x_coords = value

    @property
    def y_coords(self):
        """Message field 'y_coords'."""
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, Lane) for v in value) and
                 True), \
                "The 'y_coords' field must be a set or sequence and each value of type 'Lane'"
        self._y_coords = value
