...
bool spark_msgs__msg__goal_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "spark_msgs.msg._goal_state.GoalState",
        full_classname_dest, 36) == 0);
  }
  spark_msgs__msg__GoalState * ros_message = _ros_message;
  {  // header
  ...
  {  // goal_index
    ...
    ros_message->goal_index = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // goal_state
...
{
  /* NOTE(esteve): Call constructor of GoalState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("spark_msgs.msg._goal_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GoalState");
  ...
  {  // goal_index
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->goal_index);
    {
