...
bool spark_msgs__msg__lane_coeffs__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "spark_msgs.msg._lane_coeffs.LaneCoeffs",
...
{
  /* NOTE(esteve): Call constructor of LaneCoeffs */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("spark_msgs.msg._lane_coeffs");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LaneCoeffs");
