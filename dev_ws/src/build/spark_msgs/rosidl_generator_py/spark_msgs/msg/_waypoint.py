...
class Waypoint(metaclass=Metaclass_Waypoint):
    ...
    def __init__(self, **kwargs):
        ...
        self.waypoint = array.array('d', kwargs.get('waypoint', []))
    ...
    def waypoint(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'd', \
                "The 'waypoint' array.array() must have the type code of 'd'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'waypoint' field must be a set or sequence and each value of type 'float'"
        self._waypoint = array.array('d', value)
