...
using _Pose__ros_msg_type = spark_msgs__msg__Pose;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: closed_speed
  {
    cdr << ros_message->closed_speed;
  }

  // Field name: open_speed
  {
  ...
  size_t current_alignment)
{
  ...
  // field.name closed_speed
  {
    size_t item_size = sizeof(ros_message->closed_speed);
...
static uint32_t _Pose__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_spark_msgs__msg__Pose(
...
{
  return max_serialized_size_spark_msgs__msg__Pose(
    full_bounded, 0);
}
