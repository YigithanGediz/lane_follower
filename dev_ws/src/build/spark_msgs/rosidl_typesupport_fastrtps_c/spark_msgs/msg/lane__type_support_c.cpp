...
#include "spark_msgs/msg/lane__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/primitives_sequence.h"  // lane
#include "rosidl_generator_c/primitives_sequence_functions.h"  // lane

// forward declare type support functions


using _Lane__ros_msg_type = spark_msgs__msg__Lane;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: lane
  {
    ...
    if (ros_message->lane.data) {
      rosidl_generator_c__int16__Sequence__fini(&ros_message->lane);
    }
    if (!rosidl_generator_c__int16__Sequence__init(&ros_message->lane, size)) {
      return "failed to create array for field 'lane'";
    }
    auto array_ptr = ros_message->lane.data;
...
static uint32_t _Lane__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_spark_msgs__msg__Lane(
...
{
  return max_serialized_size_spark_msgs__msg__Lane(
    full_bounded, 0);
}
