...
#include "spark_msgs/msg/waypoints__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/primitives_sequence.h"  // waypoints
#include "rosidl_generator_c/primitives_sequence_functions.h"  // waypoints
...
using _Waypoints__ros_msg_type = spark_msgs__msg__Waypoints;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: waypoints
  {
    ...
    if (ros_message->waypoints.data) {
      rosidl_generator_c__double__Sequence__fini(&ros_message->waypoints);
    }
...
static uint32_t _Waypoints__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_spark_msgs__msg__Waypoints(
...
{
  return max_serialized_size_spark_msgs__msg__Waypoints(
    full_bounded, 0);
}
