  ...
  size_t current_alignment)
{
  ...
  // Member: waypoint
  {
    ...
    size_t item_size = sizeof(ros_message.waypoint[0]);
...
{
  auto typed_message =
    static_cast<const spark_msgs::msg::Waypoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<spark_msgs::msg::Waypoint *>(
    untyped_ros_message);
...
{
  return &spark_msgs::msg::typesupport_fastrtps_cpp::_Waypoint__handle;
}
