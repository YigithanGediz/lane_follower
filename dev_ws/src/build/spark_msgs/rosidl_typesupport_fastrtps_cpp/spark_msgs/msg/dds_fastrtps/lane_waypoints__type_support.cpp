...
#include "spark_msgs/msg/lane_waypoints__rosidl_typesupport_fastrtps_cpp.hpp"
#include "spark_msgs/msg/lane_waypoints__struct.hpp"
...
cdr_serialize(
  const spark_msgs::msg::LaneWaypoints & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: forward_x
  {
    cdr << ros_message.forward_x;
  }
  // Member: forward_y
  {
    cdr << ros_message.forward_y;
  }
  // Member: right_x
  {
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  spark_msgs::msg::LaneWaypoints & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: forward_x
  {
    ...
    size_t item_size = sizeof(ros_message.forward_x[0]);
  ...
  // Member: forward_y
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.forward_y[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: right_x
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_spark_msgs
max_serialized_size_LaneWaypoints(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const spark_msgs::msg::LaneWaypoints *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<spark_msgs::msg::LaneWaypoints *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _LaneWaypoints__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const spark_msgs::msg::LaneWaypoints *>(
...
{
  return max_serialized_size_LaneWaypoints(full_bounded, 0);
}

static message_type_support_callbacks_t _LaneWaypoints__callbacks = {
  "spark_msgs::msg",
  "LaneWaypoints",
...
static rosidl_message_type_support_t _LaneWaypoints__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LaneWaypoints__callbacks,
...
get_message_type_support_handle<spark_msgs::msg::LaneWaypoints>()
{
  return &spark_msgs::msg::typesupport_fastrtps_cpp::_LaneWaypoints__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, spark_msgs, msg, LaneWaypoints)() {
  return &spark_msgs::msg::typesupport_fastrtps_cpp::_LaneWaypoints__handle;
}
