...
#include "lgsvl_msgs/msg/signal__rosidl_typesupport_fastrtps_c.h"
...
using _Signal__ros_msg_type = lgsvl_msgs__msg__Signal;
...
static uint32_t _Signal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_lgsvl_msgs__msg__Signal(
...
{
  return max_serialized_size_lgsvl_msgs__msg__Signal(
    full_bounded, 0);
}
