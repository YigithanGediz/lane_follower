...
#include "lgsvl_msgs/msg/ultrasonic__rosidl_typesupport_fastrtps_c.h"
...
using _Ultrasonic__ros_msg_type = lgsvl_msgs__msg__Ultrasonic;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message->minimum_distance;
  }
...
size_t get_serialized_size_lgsvl_msgs__msg__Ultrasonic(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Ultrasonic__ros_msg_type * ros_message = static_cast<const _Ultrasonic__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name minimum_distance
  {
    size_t item_size = sizeof(ros_message->minimum_distance);
...
static uint32_t _Ultrasonic__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_lgsvl_msgs__msg__Ultrasonic(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_lgsvl_msgs
size_t max_serialized_size_lgsvl_msgs__msg__Ultrasonic(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _Ultrasonic__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_lgsvl_msgs__msg__Ultrasonic(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lgsvl_msgs, msg, Ultrasonic)() {
