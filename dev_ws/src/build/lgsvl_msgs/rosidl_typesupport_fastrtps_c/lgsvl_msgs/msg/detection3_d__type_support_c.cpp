...
#include "lgsvl_msgs/msg/detection3_d__rosidl_typesupport_fastrtps_c.h"
...
#include "lgsvl_msgs/msg/bounding_box3_d__functions.h"  // bbox
...
using _Detection3D__ros_msg_type = lgsvl_msgs__msg__Detection3D;
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_lgsvl_msgs__msg__BoundingBox3D(
...
static uint32_t _Detection3D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_lgsvl_msgs__msg__Detection3D(
  ...
  size_t current_alignment)
{
  ...
  // member: bbox
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_lgsvl_msgs__msg__BoundingBox3D(
        full_bounded, current_alignment);
    }
  }
  // member: velocity
...
{
  return max_serialized_size_lgsvl_msgs__msg__Detection3D(
    full_bounded, 0);
}
