...
#include "lgsvl_msgs/msg/detection2_d__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/twist__functions.h"  // velocity
#include "lgsvl_msgs/msg/bounding_box2_d__functions.h"  // bbox
...
using _Detection2D__ros_msg_type = lgsvl_msgs__msg__Detection2D;
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_lgsvl_msgs__msg__BoundingBox2D(
...
static uint32_t _Detection2D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_lgsvl_msgs__msg__Detection2D(
  ...
  size_t current_alignment)
{
  ...
  // member: bbox
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_lgsvl_msgs__msg__BoundingBox2D(
        full_bounded, current_alignment);
    }
  }
  // member: velocity
...
{
  return max_serialized_size_lgsvl_msgs__msg__Detection2D(
    full_bounded, 0);
}
