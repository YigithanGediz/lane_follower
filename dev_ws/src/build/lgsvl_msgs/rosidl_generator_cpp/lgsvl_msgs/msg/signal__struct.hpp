...
#ifndef LGSVL_MSGS__MSG__SIGNAL__STRUCT_HPP_
#define LGSVL_MSGS__MSG__SIGNAL__STRUCT_HPP_
...
struct Signal_
{
  ...
  explicit Signal_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init),
    bbox(_init)
  {
  ...
  explicit Signal_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init),
    label(_alloc),
    bbox(_alloc, _init)
  {
...
#endif  // LGSVL_MSGS__MSG__SIGNAL__STRUCT_HPP_
