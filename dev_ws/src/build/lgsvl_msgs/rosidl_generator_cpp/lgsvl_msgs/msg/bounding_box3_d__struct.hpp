...
#ifndef LGSVL_MSGS__MSG__BOUNDING_BOX3_D__STRUCT_HPP_
#define LGSVL_MSGS__MSG__BOUNDING_BOX3_D__STRUCT_HPP_
...
struct BoundingBox3D_
{
  ...
  explicit BoundingBox3D_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : position(_init),
    size(_init)
  {
    (void)_init;
  ...
  explicit BoundingBox3D_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // LGSVL_MSGS__MSG__BOUNDING_BOX3_D__STRUCT_HPP_
