...
#ifndef LGSVL_MSGS__MSG__CAN_BUS_DATA__STRUCT_HPP_
#define LGSVL_MSGS__MSG__CAN_BUS_DATA__STRUCT_HPP_
...
struct CanBusData_
{
  ...
  explicit CanBusData_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init),
    orientation(_init),
  ...
  explicit CanBusData_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init),
...
#endif  // LGSVL_MSGS__MSG__CAN_BUS_DATA__STRUCT_HPP_
