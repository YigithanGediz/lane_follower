...
#ifndef LGSVL_MSGS__MSG__VEHICLE_CONTROL_DATA__STRUCT_HPP_
#define LGSVL_MSGS__MSG__VEHICLE_CONTROL_DATA__STRUCT_HPP_
...
struct VehicleControlData_
{
  ...
  explicit VehicleControlData_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init)
  {
  ...
  explicit VehicleControlData_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // LGSVL_MSGS__MSG__VEHICLE_CONTROL_DATA__STRUCT_HPP_
