...
#ifndef LGSVL_MSGS__MSG__DETECTION3_D_ARRAY__STRUCT_HPP_
#define LGSVL_MSGS__MSG__DETECTION3_D_ARRAY__STRUCT_HPP_
...
struct Detection3DArray_
{
  ...
  explicit Detection3DArray_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init)
  {
    (void)_init;
  }

  explicit Detection3DArray_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init)
  {
    (void)_init;
  }
...
#endif  // LGSVL_MSGS__MSG__DETECTION3_D_ARRAY__STRUCT_HPP_
