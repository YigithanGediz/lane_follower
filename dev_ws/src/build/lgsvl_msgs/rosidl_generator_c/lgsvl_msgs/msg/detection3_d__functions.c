...
{
  lgsvl_msgs__msg__Detection3D * msg = (lgsvl_msgs__msg__Detection3D *)malloc(sizeof(lgsvl_msgs__msg__Detection3D));
  if (!msg) {
    return NULL;
  }
...
lgsvl_msgs__msg__Detection3D__Sequence__init(lgsvl_msgs__msg__Detection3D__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (lgsvl_msgs__msg__Detection3D *)calloc(size, sizeof(lgsvl_msgs__msg__Detection3D));
    if (!data) {
      return false;
    }
...
{
  lgsvl_msgs__msg__Detection3D__Sequence * array = (lgsvl_msgs__msg__Detection3D__Sequence *)malloc(sizeof(lgsvl_msgs__msg__Detection3D__Sequence));
  if (!array) {
    return NULL;
  }
