...
#include "lgsvl_msgs/msg/ultrasonic__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const lgsvl_msgs::msg::Ultrasonic & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  lgsvl_msgs::msg::Ultrasonic & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const lgsvl_msgs::msg::Ultrasonic *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lgsvl_msgs::msg::Ultrasonic *>(
    untyped_ros_message);
...
{
  return max_serialized_size_Ultrasonic(full_bounded, 0);
}
...
{
  return &lgsvl_msgs::msg::typesupport_fastrtps_cpp::_Ultrasonic__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lgsvl_msgs, msg, Ultrasonic)() {
  return &lgsvl_msgs::msg::typesupport_fastrtps_cpp::_Ultrasonic__handle;
}
