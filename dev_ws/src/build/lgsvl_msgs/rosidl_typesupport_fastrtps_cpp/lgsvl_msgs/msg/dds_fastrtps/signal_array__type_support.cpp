...
#include "lgsvl_msgs/msg/signal_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const lgsvl_msgs::msg::Signal &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  lgsvl_msgs::msg::Signal &);
size_t get_serialized_size(
  const lgsvl_msgs::msg::Signal &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const lgsvl_msgs::msg::SignalArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  lgsvl_msgs::msg::SignalArray & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_lgsvl_msgs
max_serialized_size_SignalArray(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // Member: signals
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        lgsvl_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Signal(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const lgsvl_msgs::msg::SignalArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lgsvl_msgs::msg::SignalArray *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SignalArray__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const lgsvl_msgs::msg::SignalArray *>(
...
{
  return max_serialized_size_SignalArray(full_bounded, 0);
}

static message_type_support_callbacks_t _SignalArray__callbacks = {
  "lgsvl_msgs::msg",
  "SignalArray",
...
static rosidl_message_type_support_t _SignalArray__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SignalArray__callbacks,
...
{
  return &lgsvl_msgs::msg::typesupport_fastrtps_cpp::_SignalArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lgsvl_msgs, msg, SignalArray)() {
  return &lgsvl_msgs::msg::typesupport_fastrtps_cpp::_SignalArray__handle;
}
