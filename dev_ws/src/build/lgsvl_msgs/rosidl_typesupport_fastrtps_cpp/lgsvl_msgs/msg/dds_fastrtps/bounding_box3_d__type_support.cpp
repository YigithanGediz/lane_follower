...
#include "lgsvl_msgs/msg/bounding_box3_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const lgsvl_msgs::msg::BoundingBox3D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lgsvl_msgs::msg::BoundingBox3D *>(
    untyped_ros_message);
...
{
  return &lgsvl_msgs::msg::typesupport_fastrtps_cpp::_BoundingBox3D__handle;
}
