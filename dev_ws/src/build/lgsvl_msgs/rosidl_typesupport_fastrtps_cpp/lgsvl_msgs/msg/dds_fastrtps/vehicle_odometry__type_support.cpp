...
#include "lgsvl_msgs/msg/vehicle_odometry__rosidl_typesupport_fastrtps_cpp.hpp"
#include "lgsvl_msgs/msg/vehicle_odometry__struct.hpp"
...
cdr_serialize(
  const lgsvl_msgs::msg::VehicleOdometry & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  lgsvl_msgs::msg::VehicleOdometry & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const lgsvl_msgs::msg::VehicleOdometry *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lgsvl_msgs::msg::VehicleOdometry *>(
    untyped_ros_message);
...
{
  return &lgsvl_msgs::msg::typesupport_fastrtps_cpp::_VehicleOdometry__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lgsvl_msgs, msg, VehicleOdometry)() {
  return &lgsvl_msgs::msg::typesupport_fastrtps_cpp::_VehicleOdometry__handle;
}
