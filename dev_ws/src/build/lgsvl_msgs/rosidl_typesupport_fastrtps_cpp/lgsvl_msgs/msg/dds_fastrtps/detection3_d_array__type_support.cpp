...
{
bool cdr_serialize(
  const lgsvl_msgs::msg::Detection3D &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  lgsvl_msgs::msg::Detection3D &);
size_t get_serialized_size(
  const lgsvl_msgs::msg::Detection3D &,
  size_t current_alignment);
size_t
  ...
  size_t current_alignment)
{
  ...
  // Member: detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        lgsvl_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Detection3D(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const lgsvl_msgs::msg::Detection3DArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lgsvl_msgs::msg::Detection3DArray *>(
    untyped_ros_message);
...
{
  return &lgsvl_msgs::msg::typesupport_fastrtps_cpp::_Detection3DArray__handle;
}
