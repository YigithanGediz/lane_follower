...
#include "lgsvl_msgs/msg/detection2_d_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const lgsvl_msgs::msg::Detection2D &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const lgsvl_msgs::msg::Detection2DArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  lgsvl_msgs::msg::Detection2DArray & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        lgsvl_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Detection2D(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const lgsvl_msgs::msg::Detection2DArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lgsvl_msgs::msg::Detection2DArray *>(
    untyped_ros_message);
...
{
  return max_serialized_size_Detection2DArray(full_bounded, 0);
}
...
{
  return &lgsvl_msgs::msg::typesupport_fastrtps_cpp::_Detection2DArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lgsvl_msgs, msg, Detection2DArray)() {
  return &lgsvl_msgs::msg::typesupport_fastrtps_cpp::_Detection2DArray__handle;
}
