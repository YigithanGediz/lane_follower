...
#include "lgsvl_msgs/msg/detection2_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const lgsvl_msgs::msg::BoundingBox2D &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const lgsvl_msgs::msg::Detection2D & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  lgsvl_msgs::msg::Detection2D & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: bbox
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        lgsvl_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_BoundingBox2D(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const lgsvl_msgs::msg::Detection2D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lgsvl_msgs::msg::Detection2D *>(
    untyped_ros_message);
...
{
  return &lgsvl_msgs::msg::typesupport_fastrtps_cpp::_Detection2D__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lgsvl_msgs, msg, Detection2D)() {
  return &lgsvl_msgs::msg::typesupport_fastrtps_cpp::_Detection2D__handle;
}
