...
#include "lgsvl_msgs/msg/detected_radar_object__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const lgsvl_msgs::msg::DetectedRadarObject & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.sensor_aim,
    cdr);
  // Member: sensor_right
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.sensor_right,
    cdr);
  ...
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.object_velocity,
    cdr);
  // Member: object_relative_position
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.object_relative_position,
    cdr);
  // Member: object_relative_velocity
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.object_relative_velocity,
    cdr);
  // Member: object_collider_size
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.object_collider_size,
    cdr);
  // Member: object_state
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  lgsvl_msgs::msg::DetectedRadarObject & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_lgsvl_msgs
max_serialized_size_DetectedRadarObject(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const lgsvl_msgs::msg::DetectedRadarObject *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lgsvl_msgs::msg::DetectedRadarObject *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DetectedRadarObject__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const lgsvl_msgs::msg::DetectedRadarObject *>(
...
{
  return max_serialized_size_DetectedRadarObject(full_bounded, 0);
}

static message_type_support_callbacks_t _DetectedRadarObject__callbacks = {
  "lgsvl_msgs::msg",
  "DetectedRadarObject",
...
static rosidl_message_type_support_t _DetectedRadarObject__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DetectedRadarObject__callbacks,
...
{
  return &lgsvl_msgs::msg::typesupport_fastrtps_cpp::_DetectedRadarObject__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lgsvl_msgs, msg, DetectedRadarObject)() {
  return &lgsvl_msgs::msg::typesupport_fastrtps_cpp::_DetectedRadarObject__handle;
}
